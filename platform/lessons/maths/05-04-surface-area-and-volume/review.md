...
For each solid: the 3D shape on the left with sides labelled, its flat net on the right with each face's area in KaTeX, and the volume + SA formulas underneath. Sphere has no flat net, because its surface cannot be unrolled.
